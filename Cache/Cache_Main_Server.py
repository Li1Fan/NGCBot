...
class Cache_Main_Server:
    def __init__(self, wcf):
        ...
        self.novel_cache = current_path + '/Novel_Cache'
    ...
    def init_cache(self):
        ...
        try:
            ...
            os.makedirs(self.novel_cache, exist_ok=True)
    ...
    def delete_file(self):
        ...
        if os.path.exists(self.video_cache):
            try:
                ...
                file_lists += [self.novel_cache + '/' + file for file in os.listdir(self.novel_cache)]
