        ...
        # Ai对话forward_msg
            ...
            if msg.sender in self.Administrators:
                if msg.content.strip() == '开启对话':
                    ...
                    return
                elif "指定回复" in msg.content.strip():
                    _, wx_id, content = msg.content.strip().split(' ')
                    self.wcf.send_text(msg=content, receiver=wx_id)
                    return
